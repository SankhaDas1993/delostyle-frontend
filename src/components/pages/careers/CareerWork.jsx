...
export default function CareerWork(){
    ...
    return(
        <div className="flex-row  justify-start top-0 bottom-0" style={{ overflow: "hidden"}}>
        <div className="relative flex justify-start flex-col mb-2 p-20 mx-20 " >
         <div className="flex">
  <div className="h-full overflow-hidden flex-1 ">
    <div className="flex justify-start mb-5">
      <img src={bulbIcon} alt="bulb-icon" className="bulb-icon mr-3" />
      <h2 className="text-orange-500 text-xl mb-2 overflow-hidden" style={{ fontSize: "20px" }}>OUR WORK</h2>
    </div>
