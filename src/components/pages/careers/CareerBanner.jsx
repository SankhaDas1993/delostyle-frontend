...
const CareerBanner = () => {
  ...
  const bannerStyle = {
    backgroundImage: isMobile ? 'none' : `url(${careerBanner})`,
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-start justify-between mx-5 md:mx-10 lg:mx-20 text-white">
        ...
        <div className="w-full mt-10 p-5 md:mt-20">
          ...
          <div className="flex flex-col items-start">
            <h2 className="text-white overflow-hidden py-2 font-bold mb-2" style={{ fontSize: isMobile ? "36px" : "60px", textAlign: 'left' }}>We Believe In The Power Of Teamwork</h2>
            <p className="text-gray-700 text-white mt-5 overflow-hidden" style={{ fontSize: isMobile ? "18px" : "24px", textAlign: 'left' }}>Our collaborative environment fosters innovation and excellence, enabling our team to consistently deliver outstanding results.</p>
