...
export default function OperationalProcess(){
  ...
  <div className="flex mb-10">
    ...
    <h2 className="text-orange-500 text-xl ml-4" style={{ fontSize: "20px" }}>OPERATIONAL PROCESS</h2>
  </div>
  <div className="flex flex-col items-start">
    <h2 className="text-white overflow-hidden py-2 font-bold mb-5" style={{ fontSize: "55px" }}>The Operational Processes Are What Drives The Business</h2>
    <p className="text-gray-700 text-white mt-5 overflow-hidden" style={{ fontSize: "24px"}}>We specialize in the project delivery model that combines strategy and cutting-edge technology into businesses, hence enabling cost efficiency across the departments.
</p>
