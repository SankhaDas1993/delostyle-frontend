    ...
    >
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between px-4 md:px-20 py-10 text-white">
        ...
        <div className="flex items-center mb-4 md:mb-10 md:ml-0 ml-0 md:justify-start justify-start">
            ...
            <h2 className="text-orange-500 text-lg md:text-xl ml-4">CAREERS</h2>
          </div>
          <div className="flex flex-col items-start">
            <h2 className="text-white font-bold mb-4 md:mb-5 text-2xl md:text-4xl">We Will Help Your Career Grow</h2>
            <p className="text-gray-300 mt-4 md:mt-5 text-base md:text-lg">We will work on your ideas and create the touchpoints to make sure of the high quality deliverables.</p>
            <button className="bg-orange-500 text-white py-2 px-4 md:py-2 md:px-6 rounded-full mt-6 md:mt-10 text-sm md:text-lg">View All Available Positions</button>
          </div>
        </div>
      </div>
    </div>
