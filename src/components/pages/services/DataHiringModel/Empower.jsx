...
export default function Empower(){
  ...
  <div className="flex flex-col items-start">
    <h2 className="text-white overflow-hidden py-2 font-bold mb-5" style={{ fontSize: "55px" }}>Empower Your Business With The Dedicated Hiring Model</h2>
    <p className="text-gray-700 text-white mt-5 overflow-hidden" style={{ fontSize: "24px"}}>Discover how our Dedicated Hiring Model (DHM) drives business success. Our expert team is ready to ensure your processes run flawlessly. Connect with us today to learn more about DHM and optimize your business operations.
</p>
