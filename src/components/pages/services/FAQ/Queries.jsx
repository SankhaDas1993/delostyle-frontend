...
export default function Queries(){
    ...
    <div className="flex mb-5 items-center mt-2 h-10">
      ...
      <h2 className="text-orange-500 text-xl" style={{ fontSize: "20px" }}>YOUR QUERIES</h2>
    </div>
    <div className="flex flex-col items-start">
      <h1 className="text-white overflow-hidden  font-bold" style={{ fontSize: "36px" }}>
      Need Answers? Get Your <br/> Queries Professionally <br/>Addressed
      </h1>
   ...
   <img src={faq2} alt="work-together-border" className=" right-0 left-40" style={{ width: '560px', height: '560px' }} />
    </div>
      </div>
