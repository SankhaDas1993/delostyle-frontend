...
export default function SmOperation({ supportData }) {
  // console.log(supportData.smOperationData.mainHeading, "supportDatasupportData")
        ...
        <div className="flex">
          <div className="h-full overflow-hidden flex-1 mx-5 p-5">
            ...
            <div className="overflow-hidden" >
              {/* <p className="overflow-hidden  font-bold mb-5  whitespace-normal w-[990px]" style={{ fontSize: "46px" }}>Support Model Help Brands Adapt And Thrive In The Professional World</p> */}
              <p className="overflow-hidden  font-bold mb-5  whitespace-normal w-[990px]" style={{ fontSize: "46px" }}>{supportData?.smOperationData?.mainHeading}</p>
            </div>
