      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-start mx-20 text-white  p-5">
        <div className="w-3/4 mt-20 z-1">
          ...
          <div className="flex flex-col items-start">
            {/* <h1 className="text-black overflow-hidden font-bold" style={{ fontSize: "44px" }}>How Does The Support Model Function?</h1> */}
            <h1 className="text-black overflow-hidden font-bold" style={{ fontSize: "44px" }}>{supportData?.smWorksData?.mainHeading}</h1>
            ...
            <p className="mt-1 overflow-hidden text-[#777777]" style={{ fontSize: "20px", padding: "20px 0" }}>{supportData?.smWorksData?.descriptionText}</p>
