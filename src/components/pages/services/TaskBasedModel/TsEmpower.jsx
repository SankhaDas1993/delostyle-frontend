...
export default function TsEmpower(){
  ...
  <div className="flex flex-col items-start">
    <h2 className="text-white overflow-hidden py-2 font-bold mb-5  whitespace-normal w-[900px]" style={{ fontSize: "55px" }}>Driving Business Success With The Task Based Model</h2>
    <p className="text-gray-700 text-white mt-5 overflow-hidden" style={{ fontSize: "24px"}}>Our experts are available to help your process run flawlessly. Get in touch with our experts and know more about Task Based Model.
