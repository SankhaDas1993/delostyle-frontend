...
const KnowTS = () => {
    ...
    return (
      ...
      <h2 className="font-bold mb-6  overflow-hidden  whitespace-normal w-[980px]" style={{fontSize:"46px"}}>Discover Our Adaptive Task-Based Model For Dynamic IT Support</h2>
