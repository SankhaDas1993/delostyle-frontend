...
export default function WhyPBM(){
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-start mx-20 text-white  p-5">
          <div className=" mt-20 mx-10">
            ...
            <div className="flex flex-col items-start">
              ...
              Why Opt For The Project Based Model?
              </h1>
              <p className="mt-1 overflow-hidden text-white" style={{ fontSize: "20px", padding: "20px 0"}}>
              The Project-Based Model (PBM) offers flexibility and precision, ensuring tailored strategies for each <br/>project. By leveraging specialized skills and efficient resource allocation, PBM reduces costs and delivers<br/> high-quality results within set timelines. Opt for PBM to enhance operational efficiency, drive innovation, <br/>and achieve exceptional outcomes.
              </p>
